...
phiDot0 = 1.                   # initial precession rate
...
time_step = math.floor(500.*(t1-t0)/N)
...
line_ani = animation.FuncAnimation(fig, update_line, N, fargs=(data, line, type), interval=time_step, blit=False)
