...
print("The damping factor is b= "+str(beta)+", and the driving amplitude is gamma= "+str(gamma))
...
def dudt(u, t):
    r = [0., 0., 0.]
    r[0] = u[1]
    r[1] = omega0*omega0*(gamma*math.cos(u[2]) - math.sin(u[0])) - 2.0*beta*u[1]
    r[2] = omega
    return r
